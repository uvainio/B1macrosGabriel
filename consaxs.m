function [f,rel] = consaxs(saxs, usaxs, con, qy1,qy2,samplename,bglong,bgshort)

% Function [f,rel] = consaxs([q saxsdata dataerr], [q usaxsdata dataerr], con, qy1, qy2,samplename,bglong,bgshort) 
%
% IN:
...
datasaxs = saxs(:,2)-bgshort;   datausaxs = usaxs(:,2)-bglong;
