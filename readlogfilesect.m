function param = readlogfilesect(filename)
...
% Edited 23.9.2008 UV, added sectors
...
param = struct('FSN',0,'Title','-','Dist',0,'Thickness',0,'Transm',0,'PosSample',-1,'Temperature',0,...
    ...
    'BeamsizeX',0,'BeamsizeY',0,'PixelSize',0,'Monitor',0,'PrimaryIntensity',0,'Fii1',0,'Fii2',0,'Fii3',0,'Fii4',0);
...
temp = fscanf(fid,'Dark current FSN:	%d\n',1);
...
temp = fscanf(fid,'Sector integration area 1 from %d to %d\n',2);
param = setfield(param,'Fii1',temp);
temp = fscanf(fid,'Sector integration area 2 from %d to %d\n',2);
param = setfield(param,'Fii2',temp);
temp = fscanf(fid,'Sector integration area 3 from %d to %d\n',2);
param = setfield(param,'Fii3',temp);
temp = fscanf(fid,'Sector integration area 4 from %d to %d\n',2);
param = setfield(param,'Fii4',temp);
