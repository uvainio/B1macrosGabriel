function [qout,intout,errout,header,errmult,energyreal,distance] = B1normintorig1(fsn1,thicknesses,orifsn,fsndc,sens,errorsens,mask,energymeas,energycalib,orig)

% [qout,intout,errout,header] = B1normintorig1(fsn1,thicknesses,orifsn,fsndc,sens,errorsens,orifsn,mask,energymeas,energycalib,orig)
%
% IN:
...
disp(sprintf('Using cetner of beam %.3f %.3f.\n',orig(1),orig(2)));

[ints,errs,header,ori,injectionEB] = B1integrateorig(fsn1,fsndc,sens,errorsens,orifsn,mask,orig);
