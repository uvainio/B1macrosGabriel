function [q,tth,qpix] = qrange(npix,data,d,firstpeak,lastpeak)
...
% d          The distance between the diffraction planes in Angstroms.
%            For silver behenate use value 58.373.
