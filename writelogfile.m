function f = writelogfile(header,ori,thick,fsndc,realenergy,distance,mult,errmult,reffsn,thickGC,injectionGC,injectionEB,pixelsize)
...
% Edited: 15.6.2009 UV, added sample rotation x and y
...
fprintf(fid,'Sample rotation around x axis:\t%.2f\n',header.Rot1);
fprintf(fid,'Sample rotation around y axis:\t%.2f\n',header.Rot2);
